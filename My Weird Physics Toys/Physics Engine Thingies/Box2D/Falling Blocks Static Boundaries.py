...
# =============================================================================
        ...
        self.box = self.body.CreatePolygonFixture(box=b2Vec2(new_mass, new_mass), density=0.0001,
                                 friction=0)
...
class Beam(object):
    def __init__(self, pos, width, height):
       ...
       self.box2d_width = self.width/2
       self.box2d_height = self.height/2
       
       self.box2d_pos = convertCoordsToBox2D(self.px, self.py)
       
       self.box2d_pos[0] += self.box2d_width
       self.box2d_pos[1] += self.box2d_height
       
       self.body = world.CreateStaticBody(
                       position = b2Vec2(self.box2d_pos[0], self.box2d_pos[1]),
                       shapes=b2PolygonShape(box=b2Vec2(self.box2d_width, self.box2d_height)))
    
    def draw(self):
        pygame.draw.rect(screen, WHITE, (self.px, self.py, self.width, self.height))
...
b1 = Beam((400, 500), 10, 10)
b2 = Beam((200, 700), 10, 10)
b3 = Beam((100, 500), 10, 10)
b4 = Beam((200, 400), 10, 10)

beams = [b1, b2, b3, b4]

for i in range(20):
    b = Beam((300+(10*i), 200+(20*i)), 20, 20)
    beams.append(b)
...
while win_loop:
    ...
    #pygame.draw.rect(screen, WHITE, (centre[0], centre[1], 100, 20))
